...
function Neckless() {
  ...
  const currentCards = Data.filter((item) => item.name === "Necklaces").slice(indexOfFirstCard, indexOfLastCard);
  ...
  return (
    <div className="ring-box">
      ...
      <div className="pagination">
        ...
        {Data.filter((item) => item.name === "Necklaces").length > indexOfLastCard && (
